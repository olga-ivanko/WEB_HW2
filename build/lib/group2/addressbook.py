...
class ConsoleRecordPrinter(RecordPrinter):
    def print_record(self, record):
        ...
        if (
            record.birthday.value != "unknown"
            and record.days_to_birthday() != f"\033[31mtoday\033[0m"
        ):
            return (
                start_line
                + "\u2502 \033[34mContact name:\033[0m {: <{width1}}\u2502 \033[34mphones:\033[0m {}  \u2502 \033[34mbirthday:\033[0m {} (\033[34m{: <3}\033[0m days to birthday)\u2502  \033[34memail:\033[0m {: <{width2}}\u2502 \033[34maddress:\033[0m {: <{width3}}\u2502".format(
                    record.name.value,
                    f"{phone_fuller}".join(p.value for p in record.phones),
        ...
        elif record.birthday.value == "unknown":
            return (
                start_line
        ...
        elif record.days_to_birthday() == f"\033[31mtoday\033[0m":
            return (
                start_line
